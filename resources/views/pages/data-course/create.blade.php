                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <div id="imageInput" class="form-text">Mohon masukkan foto dengan format .jpg, .jpeg,
                                        .png dan maksimal 2 MB.</div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div id="imageInputCourse" class="form-text">Mohon masukkan foto dengan format .jpg,
                                        .jpeg, .png dan maksimal 2 MB.</div>
                                </div>
                            </div>
